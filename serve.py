...
parser.add_argument("--port", help="Port for debug server to listen on", default=443)
parser.add_argument(
...
app.run(debug=True, threaded=True, host="0.0.0.0", port=args.port, ssl_context=('/etc/letsencrypt/live/micdex.org/fullchain.pem','/etc/letsencrypt/live/micdex.org/privkey.pem'))
